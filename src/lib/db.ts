...
async function runMigrations(db: Database): Promise<void> {
  ...
  const migrations = [
    ...
    // v0.1.7 — reference types
    `ALTER TABLE papers ADD COLUMN ref_type TEXT DEFAULT 'article'`,
    `ALTER TABLE papers ADD COLUMN publisher TEXT DEFAULT ''`,
    `ALTER TABLE papers ADD COLUMN edition TEXT DEFAULT ''`,
    `ALTER TABLE papers ADD COLUMN chapter TEXT DEFAULT ''`,
    `ALTER TABLE papers ADD COLUMN pages TEXT DEFAULT ''`,
    `ALTER TABLE papers ADD COLUMN doi TEXT DEFAULT ''`,
    `ALTER TABLE papers ADD COLUMN abstract_text TEXT DEFAULT ''`,
